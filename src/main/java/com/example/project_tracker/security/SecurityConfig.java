    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/register", "/auth/login", "/oauth2/**", "/login.html").permitAll()
                        .requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "v3/api-docs.yaml").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/user/me").hasAnyRole("ADMIN", "MANAGER", "CONTRACTOR", "DEVELOPER")
                        .requestMatchers(HttpMethod.DELETE, "/user/delete").hasAnyRole("ADMIN", "MANAGER", "CONTRACTOR", "DEVELOPER")
                        .requestMatchers(HttpMethod.PUT, "/user/update").hasAnyRole("ADMIN", "MANAGER", "CONTRACTOR", "DEVELOPER")
